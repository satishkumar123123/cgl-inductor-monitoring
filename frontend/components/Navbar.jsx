  ...
  return (
    <header className="no-print sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-md">
      <div className="max-w-[1700px] mx-auto px-4 lg:px-8 py-3 flex items-center justify-between gap-3 lg:gap-6 flex-wrap">
        ...
        {/* LOGO & BRANDING WITH 3D ICON */}
        <div className="flex items-center gap-3 shrink-0">
          <div className="group w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-600 via-indigo-600 to-cyan-500 flex items-center justify-center shadow-[0_10px_20px_-5px_rgba(37,99,235,0.4)] transition-all duration-300 transform-gpu hover:-translate-y-1 hover:rotate-6 hover:shadow-[0_15px_25px_-5px_rgba(37,99,235,0.6)] shrink-0">
            <Zap size={24} className="text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] transition-transform duration-300 group-hover:scale-110" />
          </div>
        ...
        {/* 3D ANIMATED NAVIGATION BUTTONS */}
        <nav className="flex items-center gap-2 lg:gap-4 overflow-x-visible py-2">
          
          {/* DASHBOARD BLOCK (3D EFFECT) */}
          <NavLink
            to="/dashboard"
            className={({ isActive }) =>
              `group relative flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-extrabold transition-all duration-300 shrink-0 transform-gpu cursor-pointer ${
                isActive
                  ? "bg-gradient-to-b from-cyan-50 to-cyan-100/90 border-t border-l border-cyan-300 border-b-4 border-r-2 border-b-cyan-500 border-r-cyan-400 text-cyan-900 shadow-[0_8px_16px_rgba(6,182,212,0.25)] -translate-y-1"
                  : "bg-gradient-to-b from-white to-slate-100/90 border-t border-l border-white border-b-4 border-r border-b-slate-300 border-r-slate-200 text-slate-700 shadow-[0_4px_6px_rgba(0,0,0,0.05)] hover:-translate-y-1 hover:border-b-cyan-400 hover:shadow-[0_10px_20px_rgba(6,182,212,0.2)] active:translate-y-0.5 active:border-b active:shadow-inner"
              }`
            }
          >
            <div className="p-1 rounded-lg bg-cyan-50 transition-all duration-300 group-hover:bg-cyan-100 group-hover:scale-110 group-hover:rotate-6 shadow-xs">
          ...
          {/* REPORTS DROPDOWN BLOCK (3D EFFECT) */}
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className={`group relative flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-extrabold transition-all duration-300 shrink-0 transform-gpu cursor-pointer ${
                isReportsActive || reportsOpen
                  ? "bg-gradient-to-b from-purple-50 to-purple-100/90 border-t border-l border-purple-300 border-b-4 border-r-2 border-b-purple-500 border-r-purple-400 text-purple-900 shadow-[0_8px_16px_rgba(168,85,247,0.25)] -translate-y-1"
                  : "bg-gradient-to-b from-white to-slate-100/90 border-t border-l border-white border-b-4 border-r border-b-slate-300 border-r-slate-200 text-slate-700 shadow-[0_4px_6px_rgba(0,0,0,0.05)] hover:-translate-y-1 hover:border-b-purple-400 hover:shadow-[0_10px_20px_rgba(168,85,247,0.2)] active:translate-y-0.5 active:border-b active:shadow-inner"
              }`}
            >
              <div className="p-1 rounded-lg bg-purple-50 transition-all duration-300 group-hover:bg-purple-100 group-hover:scale-110 group-hover:rotate-6 shadow-xs">
              ...
              <ChevronDown
                ...
                className={`text-purple-600 transition-all duration-300 ${
                  reportsOpen ? "rotate-180 scale-125" : "group-hover:translate-y-0.5"
                }`}
              />
            </button>
            ...
            {/* 3D DROPDOWN MENU */}
            {reportsOpen && (
              <div className="absolute top-full left-0 mt-3 w-64 bg-white/95 backdrop-blur-md border border-slate-200/80 rounded-2xl shadow-[0_20px_35px_-5px_rgba(0,0,0,0.15),0_10px_10px_-5px_rgba(0,0,0,0.04)] py-2 z-50 animate-in fade-in zoom-in-95 duration-200">
                <NavLink
                  to="/reports/pm-pot"
                  className={({ isActive }) =>
                    `group flex items-center gap-2.5 mx-1.5 px-3.5 py-2.5 rounded-xl text-xs font-black transition-all duration-200 hover:-translate-y-0.5 ${
                      isActive
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `group flex items-center gap-2.5 mx-1.5 px-3.5 py-2.5 rounded-xl text-xs font-black transition-all duration-200 hover:-translate-y-0.5 ${
                      isActive
                        ? "bg-cyan-100 text-cyan-900 shadow-sm border border-cyan-200"
          ...
          {/* PRODUCTION & DROSS BLOCK (3D EFFECT) */}
          <NavLink
            to="/production-dross"
            className={({ isActive }) =>
              `group relative flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-extrabold transition-all duration-300 shrink-0 transform-gpu cursor-pointer ${
                isActive
                  ? "bg-gradient-to-b from-emerald-50 to-emerald-100/90 border-t border-l border-emerald-300 border-b-4 border-r-2 border-b-emerald-500 border-r-emerald-400 text-emerald-900 shadow-[0_8px_16px_rgba(16,185,129,0.25)] -translate-y-1"
                  : "bg-gradient-to-b from-white to-slate-100/90 border-t border-l border-white border-b-4 border-r border-b-slate-300 border-r-slate-200 text-slate-700 shadow-[0_4px_6px_rgba(0,0,0,0.05)] hover:-translate-y-1 hover:border-b-emerald-400 hover:shadow-[0_10px_20px_rgba(16,185,129,0.2)] active:translate-y-0.5 active:border-b active:shadow-inner"
              }`
            }
          >
            <div className="p-1 rounded-lg bg-emerald-50 transition-all duration-300 group-hover:bg-emerald-100 group-hover:scale-110 group-hover:rotate-6 shadow-xs">
          ...
          {/* HISTORY BLOCK (3D EFFECT) */}
          <NavLink
            to="/history"
            className={({ isActive }) =>
              `group relative flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-extrabold transition-all duration-300 shrink-0 transform-gpu cursor-pointer ${
                isActive
                  ? "bg-gradient-to-b from-amber-50 to-amber-100/90 border-t border-l border-amber-300 border-b-4 border-r-2 border-b-amber-500 border-r-amber-400 text-amber-900 shadow-[0_8px_16px_rgba(245,158,11,0.25)] -translate-y-1"
                  : "bg-gradient-to-b from-white to-slate-100/90 border-t border-l border-white border-b-4 border-r border-b-slate-300 border-r-slate-200 text-slate-700 shadow-[0_4px_6px_rgba(0,0,0,0.05)] hover:-translate-y-1 hover:border-b-amber-400 hover:shadow-[0_10px_20px_rgba(245,158,11,0.2)] active:translate-y-0.5 active:border-b active:shadow-inner"
              }`
            }
          >
            <div className="p-1 rounded-lg bg-amber-50 transition-all duration-300 group-hover:bg-amber-100 group-hover:scale-110 group-hover:rotate-6 shadow-xs">
        ...
        <div className="flex items-center px-4 py-2 rounded-2xl bg-gradient-to-b from-white to-slate-100 border-t border-l border-white border-b-4 border-r border-b-slate-300 border-r-slate-200 shadow-[0_6px_14px_rgba(0,0,0,0.07)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(0,0,0,0.1)] shrink-0">
          <span className="text-lg lg:text-xl font-black tracking-wider uppercase drop-shadow-xs">
